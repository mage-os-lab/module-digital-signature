...
*   **WsSign (Sponsor del Progetto)**
    ...
    *   *Documentazione:* Vedi [docs/wssign-api.md](file:///home/nino/PhpstormProjects/mage-os-module-firma-digitale/docs/wssign-api.md).
*   **Dummy**
...
*   [Guida all'integrazione dei provider di firma](file:///home/nino/PhpstormProjects/mage-os-module-firma-digitale/docs/sign-provider-integration.md).
